...
3) файл notebook/parser/base_parser.by
    ...
    результат обработки каждой страницы так же сохраняется в json
    по пути notebook/parser/data/json/1_data.json

    в названии файла число 1 - указывает на номер страницы, которую парсили
